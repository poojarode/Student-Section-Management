...
<%@page import="java.sql.Connection"%>
    ...
    String sname=null,ctype=null,purpose=null,date=null,cname=null,bname=null,prn=null,rel=null,caste=null;
    %>
					...
					try
					{
						...
						while(rs1.next())
						{
							...
							bname=rs1.getString("branch");
                                                      prn=rs1.getString("sprn");
                                                      rel=rs1.getString("religion");
...
<div class="undermenuarea">
	...
	<div class="grid">
		<div class="row">
			<div class="c8">
				<h1 class="titlehead">Passing Certificate</h1>
			</div>
			<div class="c4">
		...
		<div class="row space-top">
			...
			<div class="c8 space-top">
				...
				<div class="wrapcontact">
					...
					<form action="passingdb.jsp" method="post" name="form" id="contactform" onsubmit="return validate()">
						<div class="form">
							<div class="c6 noleftmargin">
							
								<label>Centre</label>
                                                                <input type="text" name="centre" value="Govt.Polytechnic, Nashik" readonly>
...
<!--                                                                <input type="text" name="session_year" required>-->
							...
							<div class="c6 noleftmargin">
								...
								<input type="text" name="application_purpose" value="<%=purpose%>" >
								<label>Branch </label>
                                                                <input type="text" name="final_year" value="<%=bname %>" >
								<label>PRN No:</label>
								<input type="text" name="passing" value="<%=prn%>" >
								<label>Religion</label>
								<input type="text" name="division" value="<%=rel%>" >
							    <label>Sub-Caste</label>
								<input type="text" name="remark" value="<%=caste%>" >
                                                                 <label>Caste</label>
                                                                <select name="caste"><option>----select----</option>
                                                                <option value="ST">ST</option>
                                                                <option value="other">other</option>
                                                                </select
							   <label>Select District</label>
								<select name="dist"><option>----select----</option>
