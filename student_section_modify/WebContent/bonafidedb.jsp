...
try
{
	...
	Connection con=Databaseconnection.getconnection();
	String query="insert into bonafide(regno,sname,certificate_type,application_purpose,date,centre,session_year,studying_year,remark) values('"+regno+"','"+c+"','"+b+"','"+d+"','"+date+"','"+a+"','"+b1+"','"+f+"','"+e+"')";
...
ps.executeUpdate();
response.sendRedirect("bonafidepdf.jsp");
}
catch(Exception e1)
{
